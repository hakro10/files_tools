...
export const AdSlotInline: React.FC = () => {
  return (
    <div
      id="ad-slot-inline"
      className="w-full my-6 p-4 rounded-xl bg-slate-900/60 border border-dashed border-slate-800 flex flex-col items-center justify-center min-h-[120px] text-center transition-all"
    >
