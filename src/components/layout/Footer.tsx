...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full border-t border-slate-800 bg-slate-950 mt-16 text-slate-400 text-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-3 md:col-span-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-slate-100 text-base">DevSuite</span>
            </div>
          ...
          {/* Core Tools Column */}
          <div>
            <h4 className="font-semibold text-slate-200 uppercase tracking-wider text-[11px] mb-3 font-mono">
              Developer Tools
            </h4>
